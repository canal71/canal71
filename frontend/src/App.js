        ...
        <Card className="bg-gradient-to-r from-white via-gray-50 to-white shadow-2xl border-0 overflow-hidden">
          <CardContent className="p-0">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-orange-600/90 via-red-600/85 to-orange-600/90"></div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 shadow-2xl border border-orange-500/30 overflow-hidden">
              <CardContent className="p-0">
                {/* Logo Banner Header */}
                <div 
