...
function App() {
  ...
  useEffect(() => {
    ...
    adsenseScript.src = `https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=${process.env.REACT_APP_ADSENSE_CLIENT_ID || "ca-pub-5797573653969589"}`;
              ...
              <div className="flex space-x-2">
                ...
                <Button 
                  ...
                  onClick={() => {
                    ...
                    window.open(process.env.REACT_APP_DJ_PANEL_URL || "https://sp14.instainternet.com/cp/widgets/player/dj/?p=8288", '_blank', 'width=400,height=300');
                  }}
                >
                  🎵 ÉCOUTER LIVE
                </Button>
                  ...
                  <div className="text-right">
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        window.open(process.env.REACT_APP_DJ_PANEL_URL || "https://sp14.instainternet.com/cp/widgets/player/dj/?p=8288", '_blank', 'width=400,height=300,scrollbars=yes');
                      }}
                    >
                      🎵 Écouter Maintenant
                    </button>
